...
class DonationCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('admin.donationCategories.index', compact('donationCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.donationCategories.create');
    }
    ...
    public function edit(DonationCategory $donationCategory)
    {
        ...
        return view('admin.donationCategories.edit', compact('donationCategory'));
    }
    ...
    public function show(DonationCategory $donationCategory)
    {
        ...
        return view('admin.donationCategories.show', compact('donationCategory'));
    }
