    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" type="text" name="short_description" id="short_description" value="{{ old('short_description', $project->short_description) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="number" name="value" id="value" value="{{ old('value', $project->value) }}" step="0.01" required>
                @if($errors->has('value'))
                    <div class="invalid-feedback">
                        {{ $errors->first('value') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $project->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" type="text" name="reference" id="reference" value="{{ old('reference', $project->reference) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiary') ? 'is-invalid' : '' }}" type="text" name="beneficiary" id="beneficiary" value="{{ old('beneficiary', $project->beneficiary) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hide') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hide" id="hide" value="1" {{ $project->hide || old('hide', 0) === 1 ? 'checked' : '' }}>
