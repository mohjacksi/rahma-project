    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiary') ? 'is-invalid' : '' }}" type="text" name="beneficiary" id="beneficiary" value="{{ old('beneficiary', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hide') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="hide" value="0">
                    <input class="form-check-input" type="checkbox" name="hide" id="hide" value="1" {{ old('hide', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="hide">{{ trans('cruds.project.fields.hide') }}</label>
                </div>
                @if($errors->has('hide'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hide') }}
