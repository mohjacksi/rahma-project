                    ...
                    <form method="POST" action="{{ route("frontend.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Payment::PURPOSE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="purpose_{{ $key }}" name="purpose" value="{{ $key }}" {{ old('purpose', $payment->purpose) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="donor" id="donor" value="{{ old('donor', $payment->donor) }}">
                            @if($errors->has('donor'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('donor') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $payment->phone_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email" id="email" value="{{ old('email', $payment->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Payment::PAYMENT_METHOD_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="payment_method_{{ $key }}" name="payment_method" value="{{ $key }}" {{ old('payment_method', $payment->payment_method) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="show_my_name" id="show_my_name" value="1" {{ $payment->show_my_name || old('show_my_name', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $payment->address) }}">
