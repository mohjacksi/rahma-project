                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.banks.update", [$bank->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="branch" id="branch" value="{{ old('branch', $bank->branch) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iban" id="iban" value="{{ old('iban', $bank->iban) }}" required>
                            @if($errors->has('iban'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('iban') }}
                                </div>
