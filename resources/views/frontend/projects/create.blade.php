                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="beneficiary" id="beneficiary" value="{{ old('beneficiary', '') }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="hide" id="hide" value="1" {{ old('hide', 0) == 1 ? 'checked' : '' }}>
