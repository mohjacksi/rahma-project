<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('donation_category_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.donation-categories.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/donation-categories") || request()->is("admin/donation-categories/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-angle-left c-sidebar-nav-icon">
